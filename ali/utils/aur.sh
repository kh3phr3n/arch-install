...
PACKAGES=(
    ...
    'ttf-awesome/ttf-font-awesome-4.7.0-3-any.pkg.tar.xz'
    'ttf-iosevka/ttf-iosevka-custom-1.13.3-1-any.pkg.tar.xz'
    # Extras utils
    'ttf-iosevka/otfcc-0.7.0-2-x86_64.pkg.tar.xz'
    'ttf-iosevka/ttfautohint-1.7-1-x86_64.pkg.tar.xz'
